...
if(isset($_POST['btnsave'])){
    ...
    $sql = "UPDATE post SET id_cate_post = '$cate_name' , title = '$title',  avatar =  '$img', content = '$content' WHERE id = '$id'";
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" name="txtimg" value="<?php echo $row['avatar'] ?>">
                </div>
                <div class="form-group">
                    <label for=""> Nội dung bài viết </label>
                    <textarea name="content1" id="content1" cols="50" rows="20" value="<?php echo $row['content'] ?> ">
